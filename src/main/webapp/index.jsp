...
<body>
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link bg-dark bg-opacity-10 rounded-1" href="#"> Order Online </a>
                    </li>
                    <li class="nav-item">
        ...
        <!--CONTAINER-->
        <div class="fluid-container px-0 py-5 my-4 bg-light-text-center" style="background-image: url('img/pizza.png')">
            <h2 class="h1 text-center bg-light bg-opacity-50">Welcome to Pizza World</h2>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body py-3 m-auto" style="min-width: 98vw;">
                                ...
                                <footer class="card w-auto mt-3">
                                    <div class="card-header bg-light p-3">
                                        <button class="btn btn-primary float-end" type="submit">Next Step&nbsp;&nbsp;<i class="fa-solid fa-angle-right"></i></button>
                                    </div>
                                </footer>
                            </div>
                        </div>
