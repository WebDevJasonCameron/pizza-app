...
public class MenuItemsDao implements MenuItems{
    ...
    private List<MenuItem> generateMenuItems(){
        ...
        menuItems.add(new MenuItem(
                ...
                "img/img-pizzas/pizza-imf-02.png",
                14.99
        ));
        menuItems.add(new MenuItem(
                "Fresh Sausage Rodeo",
                ...
                "img/img-pizzas/pizza-imf-03.png",
                15.99
        ));
        menuItems.add(new MenuItem(
                "Vegetable Delight",
                ...
                "img/img-pizzas/pizza-imf-05.png",
                18.99
        ));
        menuItems.add(new MenuItem(
                "Ham Wonder",
                ...
                "img/img-pizzas/pizza-imf-06.png",
                14.99
        ));
        menuItems.add(new MenuItem(
                "Secret Garden",
                ...
                "img/img-pizzas/pizza-imf-08.png",
                14.99
        ));
        menuItems.add(new MenuItem(
